...
<div  className='flexbox4'>
  ...
  <p className='secondP'>10% CASHBACK UP TO ₹1000/- ON ORDERS ABOVE ₹2,999/-</p>
  <p className='secondP2'>  
<p>Valid from 22nd September to 30th September</p>
<p>Tenure Available: 3 Months</p>
<p>Transaction Value for Cashback: Rs. 2,999 
</p>
...
<div  className='flexbox4'>
  ...
  <p className='secondP2'>
    <p>Tenure available: 3 Months</p>
<p>Eligibility: All Bajaj Finserv card owners<br/></p>
<p>Transaction value: Available on all orders above Rs. 4,500/-<br/></p>
<p>Payment Gateway: Choose Razorpay at checkout</p></p>
</div>
</div>
...
<p className='Likeand'>And we believe a Headphone is more than just an instrument for sound.<br/>
It’s the key to a mind-blowing moment of emotion, bringing you closer to your favourite artist, and <br/>yourself.
We’ve curated the world’s finest headphones & earphones to help you discover the riffs, percussions, <br/>basslines and solos that were always there but never heard.</p>
...
<div className='pic'>
  ...
  <div className='pic2'>
    <h1>IT PAYS TO BE AN
AUDIOPHILE</h1>
    <p>Enjoy Incredible Members-only rewards on the world's finest headphones and <br/>earn loyalty points on every purchase.</p>
