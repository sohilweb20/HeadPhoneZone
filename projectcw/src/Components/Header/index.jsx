...
const Header = ()=>{
    return <header>
        <nav className="navbar">
           <Link to="/"><img className="logo" src="https://assets.rha-audio.com/nzssx/c/Headphone_zone_logo_3-small.png"/></Link> 
                ...
                <ul className="child-dropdown">
                    <div className="imagediv2">
                     <li >
                      ...
                      <p>Read the Headphone Zone journey <br/>
                      since 2011 as told by Raghav</p>
                     </li>
                     <li>
                    ...
                    <p>IT PAYS TO BE AN AUDIOPHILE</p>
                        <p>Enjoy Membership only Rewards<br/>loyalty Program </p>
                     </li>
                     <li className="info">
